#####################################################
# my_advent.py   350 point adventure  Python 2.x only
...
def my_input(mylist,mysent,myvars):
    ...
    while True:
        ...
        if yn == chr(32):
            ...
            sys.stdout.write(chr(32))  # overwrite to erase
            sys.stdout.write(chr(13))  # start the line over
            print ("ADVenture> "),     # redisplay the prompt
            for cc in firstword:
    ...
    while secondword != "noword":
        ...
        if yn == chr(13):
            ...
            sys.stdout.write(chr(32))  # overwrite to erase
            sys.stdout.write(chr(13))  # start the line over
            print ("Adventure> "),     # rewrite entire line sans 1 char
            for cc in firstword:
                sys.stdout.write(cc)
        ...
        if myvars[0] == 4:
            ...
            for ImLost in lost_list:
                if myvars[126] == ImLost:
                    print "You are wandering aimlessly.",
                    one_msg = 1
#
# snake blocks
#
...
#
    if myvars[0] >= 50 and myvars[0] < 60 and myvars[191] == 1:
        print "Pirate presently in room",str(myvars[172]),
...
def forest(mylist,mysent,myvars):
    if myvars[129] == "door":
        print "#" * 55
        raw_input("Start Cave Testing. Hit Enter/Return to start or stop.")
            ...
            if msn != int(move_result):
                ...
                while z < 42:
                    ...
                    while zz < 3:
                        ...
                        zz += 1
                    z += 1
                print mydirection.capitalize(), "to", room_name,
        print ""
        return myvars
#
...
def news(mylist,mysent,myvars):
    print "This is a python 2.x based Colossal Cave Adventure."
    print "It was tested on MacOS 10.1.6 Mojave and Windows 10"
